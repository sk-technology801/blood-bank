...
const Contact = () => {
  ...
  // ✅ API Call Added (from your first snippet)
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-red-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            We’re here to answer your questions, provide support, or help you
            get involved with our mission to save lives.
          </p>
          <button
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Reach out to us through any of the following methods for
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">
                For urgent needs, call our 24/7 hotline.
              </p>
              <button
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">
                Visit our primary donation center.
              </p>
              <Link
                href="/locations"
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">
                We’re available around the clock for emergencies.
              </p>
              <Link
                href="/contact"
                className="text-red-600 font-semibold hover:text-red-700 flex items-center justify-center"
            ...
            {[
              {
                ...
                answer:
                  "You can schedule a donation by visiting our donation page or calling our hotline at +1 (555) 911-BLOOD.",
              },
              {
                question: "Can I volunteer with the blood bank?",
                answer:
                  "Yes! Contact us through this form or our hotline to learn about volunteer opportunities.",
              },
              {
      ...
      <section className="py-20 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">
            Join our mission by donating blood or volunteering with us.
          </p>
